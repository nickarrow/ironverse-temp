...
---
`iv-move:Undertake an Expedition|Edge|2|3|0|2|3|move:starforged/exploration/undertake_an_expedition`  `iv-track-advance:(Ex) Find Someone to Check Her Ship|The Starforged/Campaign Sable Rowe/Progress/Find Someone to Check Her Ship.md|16|24|dangerous|1`  `iv-move:Explore a Waypoint|Wits|6|2|0|7|6|move:starforged/exploration/explore_a_waypoint`  `iv-track-advance:(Ex) Find Someone to Check Her Ship|The Starforged/Campaign Sable Rowe/Progress/Find Someone to Check Her Ship.md|24|32|dangerous|1`  `iv-oracle:Descriptor|20|Confined|oracle_rollable:starforged/core/descriptor`  `iv-oracle:Focus|62|Person|oracle_rollable:starforged/core/focus`  `iv-entity-create:NPC|Ayako “Longshot” Khosla|The Starforged/NPCs/Ayako “Longshot” Khosla.md`  `iv-ooc:Male 1 | Female 2`  `iv-dice:1d2|1` 
